...
export default function UrlInput({ value, prefix, suffix, addonText, onChange, ...rest }) {
    let _value = value || '';
    ...
    return (
        <Input
            ...
            addonAfter={<UrlNode value={value} prefix={prefix} suffix={suffix} addonText={addonText} />}
            {...rest}
        />
    );
}

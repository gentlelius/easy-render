import { removeEmptyItemFromList, cleanEmpty, removeHiddenFromResult , isObject, clone } from './utils';
...
export const transformDataWithBind = (data, flatten) => {
    ...
    const isMultiBind = (bind) => Array.isArray(bind) && bind.every((item) => typeof item === 'string');
